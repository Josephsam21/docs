---
title: "LASUMedScreen System Architecture: Full-Stack Overview"
sidebarTitle: "Overview"
description: "High-level architecture of LASUMedScreen: Next.js 15 frontend, Supabase backend, Edge Functions, and Resend email in a modern full-stack design."
---

LASUMedScreen follows a modern full-stack architecture with a clear separation between the presentation layer (Next.js 15 App Router), the data layer (Supabase Postgres), and asynchronous processing (Supabase Edge Functions and Resend). Each layer has a single, well-defined responsibility — making the system easier to extend, test, and reason about as your institution's screening workflows grow.
...
| --- | --- | --- |
| Presentation | React 19 and Tailwind CSS | UI components, forms, dashboards |
